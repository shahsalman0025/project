...
import AnginaQuestionList from './asthamaQuestionList'

let index=0;
const AsthamaMainQuestions = () => {
  ...
  return (
    ...
    <div className="Radio__content">
        ...
        {quiz ?<div className="Radio__mcqs">
            <h5>Please select what you think the most appropriate investigations would be with regards to Lucy Winter</h5> 
            <div className='left'><div>
            { pulseCheck=="pulse"? <label ><input type="radio" checked disabled />Peak flow</label>:<label ><input type="radio" disabled  />Peak flow</label> }
        <div>{ ecg=="ecg"? <label ><input type="radio" checked disabled />Chest xray</label>:<label ><input type="radio" disabled  />Chest xray</label> }</div>
        <div>{ pressure=="pressure"? <label ><input type="radio" checked disabled />Spirometry</label>:<label ><input type="radio" disabled  />Spirometry</label> }</div>
        <div>{ serum=="serum"? <label ><input type="radio" checked disabled />Symptom history</label>:<label ><input type="radio" disabled  />Symptom history</label> }</div>
            ...
            <div className='Radio__mcqs_div'>
                ...
                <label ><input type="radio" value="pressure"onChange={(e)=>setPressure(e.target.value)}   /> Spirometry</label>
                <label ><input type="radio"  />U&E’s</label>
                <label ><input type="radio"  />Urine dipstick</label>
                <label ><input type="radio" value="pulse" onChange={(e)=>setPulseCheck(e.target.value)} />Peak flow </label>
                </div>
                <div className='mcqs__col'>
                <label ><input type="radio" value="ecg"  onChange={(e)=>setEcg(e.target.value)}  />Chest xray</label>
                <label ><input type="radio"  />Serum Electrolytes</label>
                <label ><input type="radio" value="serum" onChange={(e)=>setSerum(e.target.value)}  />Symptom history</label>
   ...
   <div className="button-toolbar">
    ...
    {showScore ?(
      ...
      <div className="correct-answer">Q1. Blood basophil count is the correct answer</div>
      <div className="correct-answer">Q2. Salbutamol is the correct answer  </div>
      <div className="correct-answer"> Q3. Nasal congestion is correct answer </div>
      <div className="correct-answer"> Q4. Being underweight is correct answer </div> 
      <div className="correct-answer"> Q5. true is correct answer </div>
...
export default AsthamaMainQuestions;
