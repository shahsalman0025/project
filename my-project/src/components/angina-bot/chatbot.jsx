...
import imguser from '../../Assets/angina.png';
    ...
    <div class="left">
      ...
      <div className='bot_area'>
        <Chatbot config={config} messageParser={MessageParser} actionProvider={ActionProvider}
          bubbleStyle={{ fontSize: '5px' }} enableSmoothScroll={true} />
      </div>
    </div>
    <div class="right">
      ...
      <button class="bg-skyblue">
        <Link to='/agina_main_question'>End Consultation</Link></button>
    ...
    <div className='orbit__modal-content'>
      <div className='modal-header'>
        ...
        <div class="modal_body">
          ...
          <div class="heading">
            <h3 className='Font_Lato'>Hints board</h3>
          </div>
          ...
          <div class="round sky">
            ...
            <p>
               Have you asked about red flags? What are the <br /> red flags for cardiovascular system? </p>
          </div>
        </div>
      </div>
    </div>
