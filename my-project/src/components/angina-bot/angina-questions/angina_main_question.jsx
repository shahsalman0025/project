...
import AnginaQuestionList from './anginaQuestionList'
let index=0;
const AnginaMainQuestions = () => {
  ...
  return (
    ...
    <div className="Radio__content">
        ...
        {quiz ?<div className="Radio__mcqs">
            <h5>Please select what you think the most appropriate investigations would be with regards to Daniel</h5>
   ...
   <div className="button-toolbar">
    ...
    {showScore ?(
      ...
      <div className="correct-answer">Q1. Chronic stable angina is the correct answer </div>
      <div className="correct-answer">Q2. Calcium channel blocker or beta blocker </div>
      <div className="correct-answer"> Q3. Nicorandil is correct answer </div>
      <div className="correct-answer"> Q4. Unstable angina is correct answer </div> 
...
export default AnginaMainQuestions;
