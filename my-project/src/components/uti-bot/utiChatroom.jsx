...
import UtiKeywards from './uti-keywards.js';
import Uticonfig from './uti-config.js';
import UtiAnswers from './uti-answers.js';

import imguser from '../../Assets/lucywinter.png';
    ...
    <div class="chatroom">
      <div class="left">
        <div class="headerc">
          ...
          <div class="links">
            <div class="text">
              <h5><strong>Chat to Lucy Winters</strong></h5>
            </div>
            <div class="link_btns">
              <button class="bg-blue">Patients Blood</button>
       ...
       <Chatbot
        config={Uticonfig}
        messageParser={UtiKeywards}
        actionProvider={UtiAnswers}
      ...
      <div class="right">
        ...
        <button class="bg-skyblue">
          <Link to='/uti_main_question'>End Consultation</Link></button>
        ...
        <div className='modal-header'>
          ...
          <div class="modal_body">
            ...
            <div class="round sky">
              ...
              <p>
              Have they experienced anything like this before? </p>
            </div>
            <div class="round sky">
  
              <p>
              When did it start? How did it start? <br /> How long have they had the symptoms? </p>
            </div>
            <div class="round sky">
  
              <p>
              Have you asked about red flags? What are <br /> the red flags for the genitourinary system?<br /> </p>
            </div>
          </div>
        </div>
      </div>
