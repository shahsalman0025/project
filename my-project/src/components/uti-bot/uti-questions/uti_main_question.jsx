...
import AnginaQuestionList from './utiQuestionList'

let index=0;
const UtiMainQuestions = () => {
  ...
  return (
    ...
    <div className="Radio__content">
        ...
        {quiz ?<div className="Radio__mcqs">
            <h5>Please select what you think the most appropriate investigations would be with regards to Alice Jones</h5> 
            <div className='left'><div>
            { pulseCheck=="pulse"? <label ><input type="radio" checked disabled />Urine dipstick</label>:<label ><input type="radio" disabled  />Urine dipstick</label> }
        <div>{ ecg=="ecg"? <label ><input type="radio" checked disabled />Symptom history</label>:<label ><input type="radio" disabled  />Symptom history</label> }</div>
            ...
            <div className='Radio__mcqs_div'>
                ...
                <label ><input type="radio" value="pressure"  /> Blood Pressure</label>
                <label ><input type="radio"  />U&E’s</label>
                <label ><input type="radio"  />Pulse Check</label>
                <label ><input type="radio" value="pulse" onChange={(e)=>setPulseCheck(e.target.value)} />Urine dipstick </label>
                </div>
                <div className='mcqs__col'>
                ...
                <label ><input type="radio" value="serum"  />Serum eletrolytes</label>
   ...
   <div className="button-toolbar">
    ...
    {showScore ?(
      ...
      <div className="correct-answer">Q1. Nitrofurantoin 100mg MR BD for 3 days is the correct answer </div>
      <div className="correct-answer">Q2. Nitrofurantoin 100mg MR BD for 7 days is the correct </div>
      <div className="correct-answer"> Q3. Escherichia coli is correct answer </div>
      <div className="correct-answer"> Q4. 7 days is correct answer </div> 
      <div className="correct-answer"> Q5. Nitrofurantoin  is correct answer </div>
...
export default UtiMainQuestions;
