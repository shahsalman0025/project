...
import MigraineKeywards from './migraine-keywards.js';
import Migraineconfig from './migraine-config.js';
import MigraineAnswers from './migraine-answers.js';

import imguser from '../../Assets/juliawinter.png';
    ...
    <div class="chatroom">
      <div class="left">
        <div class="headerc">
          ...
          <div class="links">
            <div class="text">
              <h5><strong>Chat to Jack Wilby</strong></h5>
            </div>
            <div class="link_btns">
       ...
       <Chatbot
        config={Migraineconfig}
        messageParser={MigraineKeywards}
        actionProvider={MigraineAnswers}
      ...
      <div class="right">
        ...
        <button class="bg-skyblue">
          <Link to='/migraine_main_question'>End Consultation</Link></button>
        ...
        <div className='modal-header'>
          ...
          <div class="modal_body">
            ...
            <div class="round sky">
              ...
              <p>
              What type of headaches present unilaterally?
              </p>
            </div>
            <div class="round sky">
  
              <p>
              What type of headaches can affect daily activities?
                </p>
            </div>
            <div class="round sky">
  
              <p>
              Have you asked about social history? Any stress?
                </p>
            </div>
            <div class="round sky">
  
              <p>
              Have you asked about red flags? <br /> What are the red flags for headaches?
                </p>
            </div>
          </div>
        </div>
...
export default MigraineChatRoom;